...
export const metadata: Metadata = {
  title: "Next.js Avatars | Bharathraj Gowda - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for Bharathraj Gowda - Next.js Tailwind CSS Admin Dashboard Template",
};
