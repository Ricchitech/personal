...
export const metadata: Metadata = {
  title: "Next.js Buttons | Bharathraj Gowda - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for Bharathraj Gowda - Next.js Tailwind CSS Admin Dashboard Template",
};
