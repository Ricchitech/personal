...
export const metadata: Metadata = {
  title: "Next.js Modals | Bharathraj Gowda - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for Bharathraj Gowda - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
