...
export const metadata: Metadata = {
  title: "Next.js Badge | Bharathraj Gowda - Next.js Dashboard Template",
  description:
    "This is Next.js Badge page for Bharathraj Gowda - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
